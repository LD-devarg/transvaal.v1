...
from .views import (
    ...
    GenerarPDFView, EnviarPreliquidacionTelegramView,
)
...
urlpatterns = [
    ...
    path('preliquidaciones/<int:pk>/telegram/',                  EnviarPreliquidacionTelegramView.as_view(), name='preliquidacion_telegram'),
